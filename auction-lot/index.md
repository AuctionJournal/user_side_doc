...
Lots are the items bidders compete for inside an **auction** you run in the Auctioneer Dashboard.
...
- [What is lot qr labels? how to use it?](lot-qr-labels.md)
- [Explain lot categories](lot-categories.md)
...
- [How do I create an instant lot during live bidding?](instant-lot-live.md)
...
- [Build an auction](../auction/index.md)
- [Search auctions (bidder)](../bidder/search-auctions.md)
