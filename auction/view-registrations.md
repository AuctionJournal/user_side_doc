...
![Registration tab — bidder list](../image/auction/auction-dashboard-registration-list.png "Registration tab")
...
![Expanded registration row](../image/auction/registration-row-expanded.png "Expanded row")
